...
class CloudinaryService {
  /// Segmento aleatorio para `public_id` (no adivinable por secuencia).
  ...
  /// Sube la imagen en [folder] con un `public_id` aleatorio por archivo.
  /// La URL final incluye ese id (p. ej. .../eveta/categories/logo/xxxxx).
  ///
  /// [fileName] solo afecta el nombre del parte multipart (tipo MIME); el
  /// nombre público en Cloudinary lo fija [publicId] generado aquí.
  static Future<String> uploadImage({
    ...
    final uploadPreset = dotenv.env['NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET'] ?? '';
