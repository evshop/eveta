...
PORTAL_AUTH_SUPABASE_URL=${PORTAL_AUTH_SUPABASE_URL:-}
PORTAL_AUTH_SUPABASE_ANON_KEY=${PORTAL_AUTH_SUPABASE_ANON_KEY:-}
...
flutter build web --release \
  ...
  --dart-define=PORTAL_AUTH_SUPABASE_URL="${PORTAL_AUTH_SUPABASE_URL:-}" \
  --dart-define=PORTAL_AUTH_SUPABASE_ANON_KEY="${PORTAL_AUTH_SUPABASE_ANON_KEY:-}"
